                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        ...
                                        <asp:Button ID="BtnGravaGEDFotoDisco" runat="server" Text="GED Foto - Disco" 
                                            Visible="False" Width="50px" />
                                        <asp:Button ID="BtnGravaGEDCVDisco" runat="server" Text="GED CV - DISCO" 
                                            Visible="False" Width="50px" />
                                        <cc1:DGTECTextBox ID="txtNumIni" runat="server" Height="17px" Width="60px" 
                                            Visible="False">1</cc1:DGTECTextBox>
                    ...
                    <tr>
                        <td>
                            ...
                            <cc1:DGTECPanel ID="PanelTel" runat="server" Visible="False" Enabled="False" CssClass="caixa-form"
                                ...
                                <table border="0" cellpadding="10" width="519px">
                                    <tr>
                                        ...
                                        <td width="31">
                                            <cc1:DGTECTextBox ID="txtDDD" runat="server" Height="17px" Width="32px" 
                                                MaxLength="2"></cc1:DGTECTextBox>
                                        </td>
                                        <td style="width: 16px">
                                            &nbsp; )&nbsp;
                                        </td>
                                        <td style="width: 129px">
                                            <cc1:DGTECTextBox ID="TxtTel" runat="server" Height="17px" AutoPostBack="True" 
                                                MaxLength="10"></cc1:DGTECTextBox>
                                        </td>
                                        <td width="37px">
                                            <cc1:DGTECLabel ID="lblRamal" runat="server" Text="Ramal" Visible="False" />
                                        </td>
                                        <td>
                                            <cc1:DGTECTextBox ID="TxtRamal" runat="server" Height="17px" Width="60px" 
                                                AutoPostBack="True" MaxLength="5" Visible="False" />
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%">
                                    <tr align="right">
                                        <td>
                                            <cc1:DGTECButton ID="btnGravarTel" runat="server" Text="Inserir Telefone" />
                                        </td>
                                    </tr>
                                </table>
                            </cc1:DGTECPanel>
                            ...
                            <cc1:DGTECPanel ID="PanelInf" runat="server" Visible="False" Enabled="False" CssClass="caixa-form"
                                ...
                                <table border="0" cellpadding="10" width="519px" runat="server" id="tbSituacaoPF" visible="false" >
                                    <tr>
                                ...
                                <table border="0" cellpadding="10" width="519px">
                                    <tr>
                                        ...
                                        <td style="width: 65px">
                                            <cc1:DGTECRadioButtonList ID="RdSit" runat="server" Width="83px">
                                                <asp:ListItem Value="OptOK">OK</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="OptPendente">Pendente</asp:ListItem>
                                            </cc1:DGTECRadioButtonList>
                                        </td>
                                        <td>
                                            <cc1:DGTECLabel ID="lblProvisorio1" runat="server" ForeColor="Red" 
                                                Visible="False">Prorrogação Provisório(dias)</cc1:DGTECLabel>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <cc1:DGTECTextBox ID="TxtDiasPrazo" runat="server" Height="17px" 
                                                Visible="False" Width="40px">0</cc1:DGTECTextBox>
                                            <br />
                                            <cc1:DGTECLabel ID="lblInternet" runat="server" ForeColor="Red" Visible="False">Intranet </cc1:DGTECLabel>
&nbsp;
                                            <cc1:DGTECLabel ID="lblProvisorio" runat="server" ForeColor="Red" 
                                                Visible="False">Provisório</cc1:DGTECLabel>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellpadding="10" width="519px">
                            ...
                            <cc1:DGTECPanel ID="pnlProfissao" runat="server" Visible="False" Enabled="False"
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td >
                                            <cc1:DGTECDropDownList ID="CboOrgao_Per" runat="server" Width="300px" Height="19px"
                                                AutoPostBack="True">
                                            </cc1:DGTECDropDownList>
                                        </td>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="right">
                                            <cc1:DGTECButton ID="btnGravarProfissao" runat="server" 
                                                Text="Inserir Profissão" />
                                        </td>
                                    </tr>
                                </table>
                            </cc1:DGTECPanel>
