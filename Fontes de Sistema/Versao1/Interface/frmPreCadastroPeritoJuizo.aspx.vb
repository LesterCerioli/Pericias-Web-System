...
Partial Public Class frmPreCadastroPeritoJuizo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            Try
                ...
                If Not PanelEndRes.Visible And Not PanelEndCom.Visible And Not PanelTel.Visible And Not PanelProfissao.Visible _
                   And Not PanelInfAdic.Visible Then
                    'logger.Debug("BtnEndRes_Click...")
                    PanelEndRes.Visible = True
                    PanelEndCom.Visible = False
                    PanelTel.Visible = False
                    PanelProfissao.Visible = False
                    PanelInfAdic.Visible = False
                    BtnEndRes.Font.Bold = True
                    BtnEndCom.Font.Bold = False
                    BtnTelefone.Font.Bold = False
                    BtnProfissao.Font.Bold = False
                    BtnInfAdic.Font.Bold = False
                End If
    ...
    Protected Sub BtnGravar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnGravar.Click
        'Dim NumTelContato As Integer = 0
        Dim dtTelefoneGrv As DataTable

        dtTelefoneGrv = getSessionTelefone()
        ...
        If txtDt_Nasc.Text = "" Then
            MsgErro("Favor informar a Data de Nascimento.")
            Exit Sub
        End If
        'MsgErro(txtCEP.Text + CboUF.Text + CboBairro.Text + CboCidade.Text + CboTip_Logr.Text + txtNome_Logr.Text + txtNum_Logr.Text)

        If Trim(txtCEP.Text) = "" Or _
          Trim(CboUF.Text) = "" Or _
          Trim(CboBairro.Text) = "" Or _
          Trim(CboCidade.Text) = "" Or _
          Trim(CboTip_Logr.Text) = "" Or _
          Trim(txtNome_Logr.Text) = "" Or _
          Trim(txtNum_Logr.Text) = "" Then
            MsgErro("Favor preencher corretamente o Endereço Residencial(Obrigatório)")
            Exit Sub
        End If
        'MsgErro(Str(GrdTel.Rows.Count))

        If GrdTel.Rows.Count = 0 Then
            MsgErro("Favor cadastrar pelo menos um telefone de contato.")
            Exit Sub
        End If

        If dtTelefoneGrv Is Nothing Then
            MsgErro("Favor cadastrar pelo menos um telefone de contato.")
            Exit Sub
        End If
        ...
        Else
            ...
            Exit Sub
        End If
        'MsgErro("Pré-cadastro realizado com sucesso! Comparecer a Divisão de Perícias Judiciais (Av. Erasmo Braga, 115 - Lâmina I / Sala 315 - Corredor C - Centro, RJ) " + _
        '       "para apresentação dos documentos necessários constantes neste site, em até 30 dias, sob pena de seu cancelamento." + _
        '        "Favor entrar em contato com a DIPEJ para agendamento através do telefones 3133-4494 ou 3133-3773 ou do e-mail dipejperíciasjudiciais@tjrj.jus.br.")
        MsgErro("Pré-cadastro realizado com SUCESSO! O perito deverá comparecer a esta Divisão de Perícias Judiciais - DIPEJ, situada na Av. Erasmo Braga, 115 - Lâmina I / Sala 315 - Corredor C - Centro, RJ, " + _
                "para apresentação dos documentos descritos no artigo 2º ou 3º da Resolução 03/2011 do E. Conselho da Magistratura, conforme o caso, no prazo de 60 dias, sob pena de cancelamento deste. Referidos " + _
                "documentos poderão ser encaminhados por ofício do juiz, frisando que a ausência de quaisquer deles inviabilizará a conclusão do cadastro. " + _
                "A data para comparecimento na DIPEJ deverá ser agendada através dos telefones 3133-4494 ou 3133-3773")
    ...
    Protected Sub txtCPF_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txtCPF.TextChanged
        ...
        If txtCPF.Text <> "" Then
            ...
            If Not ValidarCPFServ(txtCPF.Text) And txtCPF.Text <> "" Then
                ...
                txtCPF.Text = ""
                txtCPF.Focus()
                upPrincipal.UpdateMode = 1 '"CONDICIONAL"
                upPrincipal.Update()
                Exit Sub
            Else
                ...
                Else
                    txtNome.Focus()
                    'upPrincipal.Update()
                    'upPrincipal.UpdateMode = "CONDICIONAL"
                    'upPrincipal.Update()
                End If
            End If
            '  TabContainer1.ActiveTabIndex = 0
...
#End Region
    ...
    Protected Sub btnNurDesmarcarTodos_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnNurDesmarcarTodos.Click
        ...
        DsNur1.AcceptChanges()
        Session("DsNur1") = DsNur1
        BtnNur1.Enabled = True
        BtnNur1.BackColor = Drawing.Color.Brown
        BtnNur1.ForeColor = Drawing.Color.Red
        ...
        DsNur2.AcceptChanges()
        Session("DsNur2") = DsNur2
        BtnNur2.Enabled = True
        BtnNur2.BackColor = Drawing.Color.Brown
        BtnNur2.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur3") = DsNur3
        BtnNur3.BackColor = Drawing.Color.Brown
        BtnNur3.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur4") = DsNur4
        BtnNur4.BackColor = Drawing.Color.Brown
        BtnNur4.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur5") = DsNur5
        BtnNur5.BackColor = Drawing.Color.Brown
        BtnNur5.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur6") = DsNur6
        BtnNur6.BackColor = Drawing.Color.Brown
        BtnNur6.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur7") = DsNur7
        BtnNur7.BackColor = Drawing.Color.Brown
        BtnNur7.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur8") = DsNur8
        BtnNur8.BackColor = Drawing.Color.Brown
        BtnNur8.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur9") = DsNur9
        BtnNur9.BackColor = Drawing.Color.Brown
        BtnNur9.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur10") = DsNur10
        BtnNur10.BackColor = Drawing.Color.Brown
        BtnNur10.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur11") = DsNur11
        BtnNur11.BackColor = Drawing.Color.Brown
        BtnNur11.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur12") = DsNur12
        BtnNur12.BackColor = Drawing.Color.Brown
        BtnNur12.ForeColor = Drawing.Color.Red
        ...
        Session("DsNur13") = DsNur13
        BtnNur13.BackColor = Drawing.Color.Brown
        BtnNur13.ForeColor = Drawing.Color.Red
    End Sub
    ...
    Private Sub txtDt_Nasc_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDt_Nasc.TextChanged
        Dim m_Dt_Nasc_Ano As String
        If txtDt_Nasc.Text = "1/1/1900" Or txtDt_Nasc.Text = "01/01/1900" Or txtDt_Nasc.Text = "01/1/1900" Or txtDt_Nasc.Text = "1/01/1900" Then
            MsgErro("Data Inválida!")
            txtDt_Nasc.Text = ""
            Exit Sub
        End If
        If Mid(txtDt_Nasc.Text, 7, 2) <> "19" And Mid(txtDt_Nasc.Text, 7, 2) <> "20" And Mid(txtDt_Nasc.Text, 7, 2) <> "" Then
            'MsgErro("O Ano deverá ter 4 dígitos, iniciados por 19 ou 20")
            MsgErro("O Ano deverá ter 4 dígitos!")
            m_Dt_Nasc_Ano = txtDt_Nasc.Text
            txtDt_Nasc.Text = Mid(m_Dt_Nasc_Ano, 1, 5)
            txtDt_Nasc.Text = ""
        End If
    End Sub

    Private Sub txtDt_Nasc_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDt_Nasc.Unload
        Dim m_Dt_Nasc_Ano As String
        If txtDt_Nasc.Text = "1/1/1900" Or txtDt_Nasc.Text = "01/01/1900" Or txtDt_Nasc.Text = "01/1/1900" Or txtDt_Nasc.Text = "1/01/1900" Then
            MsgErro("Data Inválida!")
            txtDt_Nasc.Text = ""
    ...
    'Private Sub mskDtNascimento_ResolveControlID(ByVal sender As Object, ByVal e As AjaxControlToolkit.ResolveControlEventArgs) Handles mskDtNascimento.ResolveControlID
    '    If txtDt_Nasc.Text = "1/1/1900" Or txtDt_Nasc.Text = "01/01/1900" Or txtDt_Nasc.Text = "01/1/1900" Or txtDt_Nasc.Text = "1/01/1900" Then
    '        MsgErro("Data Inválida!.............................................")
    '        txtDt_Nasc.Text = ""
    '        Exit Sub
    ...
    'Private Sub mskDtNascimento_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles mskDtNascimento.Unload
    '    If txtDt_Nasc.Text = "1/1/1900" Or txtDt_Nasc.Text = "01/01/1900" Or txtDt_Nasc.Text = "01/1/1900" Or txtDt_Nasc.Text = "1/01/1900" Then
    '        MsgErro("Data Inválida!............")
    '        txtDt_Nasc.Text = ""
    '        Exit Sub
    ...
    Protected Sub BtnEndRes_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles BtnEndRes.Click
        'logger.Debug("BtnEndRes_Click...")
        PanelEndRes.Visible = True
        PanelEndCom.Visible = False
        PanelTel.Visible = False
    ...
    Protected Sub BtnEndCom_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles BtnEndCom.Click
        ...
        PanelProfissao.Visible = False
        PanelInfAdic.Visible = False
        BtnEndRes.Font.Bold = False
        BtnEndCom.Font.Bold = True
        BtnTelefone.Font.Bold = False
        BtnProfissao.Font.Bold = False
        BtnInfAdic.Font.Bold = False
    End Sub

    Protected Sub BtnTelefone_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnTelefone.Click
        ...
        BtnEndRes.Font.Bold = False
        BtnEndCom.Font.Bold = False
        BtnTelefone.Font.Bold = True
        BtnProfissao.Font.Bold = False
        BtnInfAdic.Font.Bold = False
        ListarTelefone()
    End Sub

    Protected Sub BtnProfissao_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles BtnProfissao.Click
        'logger.Debug("BtnProfissao_Click...")
        PanelEndRes.Visible = False
        PanelEndCom.Visible = False
        PanelTel.Visible = False
        PanelProfissao.Visible = True
        PanelInfAdic.Visible = False
        BtnEndRes.Font.Bold = False
        BtnEndCom.Font.Bold = False
        BtnTelefone.Font.Bold = False
        BtnProfissao.Font.Bold = True
        BtnInfAdic.Font.Bold = False
    End Sub

    Protected Sub BtnInfAdic_Click1(ByVal sender As Object, ByVal e As EventArgs) Handles BtnInfAdic.Click
        'logger.Debug("BtnInfAdic_Click...")
        PanelEndRes.Visible = False
        PanelEndCom.Visible = False
        PanelTel.Visible = False
        PanelProfissao.Visible = False
        PanelInfAdic.Visible = True
        BtnEndRes.Font.Bold = False
        BtnEndCom.Font.Bold = False
        BtnTelefone.Font.Bold = False
        BtnProfissao.Font.Bold = False
        BtnInfAdic.Font.Bold = True
    End Sub

    Protected Sub CboBairro1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles CboBairro1.SelectedIndexChanged

    End Sub

    Private Sub CboBairro1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CboBairro1.TextChanged
        CboTip_Logr1.Enabled = True
        PreencherTip_Logr1()
    End Sub
End Class
