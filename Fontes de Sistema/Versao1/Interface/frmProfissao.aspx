    ...
    <table class="corpo-form" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr align="center">
            <td>
                ...
                &nbsp;
                <cc1:DGTECButton ID="BtnExcluir" runat="server" Text="Excluir" Width="60px" OnClientClick="javascrit:return window.confirm('Tem certeza que deseja excluir a profissão?');" />
                 &nbsp;
