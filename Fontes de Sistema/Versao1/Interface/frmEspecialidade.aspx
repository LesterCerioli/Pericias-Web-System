    ...
    <table class="corpo-form" width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr align="center">
            <td>
                ...
                <cc1:DGTECButton ID="BtnExcluir" runat="server" Text="Excluir" Width="60px" OnClientClick="javascrit:return window.confirm('Tem certeza que deseja excluir a especialização?');"/>&nbsp;
                <cc1:DGTECButton ID="BtnLimpar" runat="server" Text="Limpar" Width="60px" />
            </td>
        </tr>
    </table>
    </form>
