<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PerMasterPagePerito.Master" CodeBehind="frmConsPerProc.aspx.vb" Inherits="Interface.frmConsPerProc" 
  %>
...
<table class="corpo-form">
    ...
    <table border="0" cellpadding="10" width="520">
        <tr>
            ...
            <td colspan="2" width="150">
                <asp:TextBox ID="TxtTipoProc" runat="server" Width="100px" Enabled="False">Primeira  Instância</asp:TextBox>
                &nbsp;
           </td>
           <td>
               Data da Nomeação
               ...
               <td>
                <cc1:DGTECTextBox ID="txtData_Nomeacao" runat="server" Enabled="False" 
                   Width="100px"></cc1:DGTECTextBox>
               </td>
         </tr>
    </table>
       <table border="0" cellpadding="10" width="520">
    ...
    <table border="0" cellpadding="10" width="520">
            ...
            <td>
                ...
                <cc1:DGTECGridView ID="GrdProcessos" runat="server" Width="516px" 
                    ...
                    <Columns>
                        <asp:CommandField SelectText="Exibir" ShowSelectButton="True" 
                            HeaderText="       " />
                        <asp:BoundField DataField = "Linha" HeaderText = "Linha" Visible = False />
                        <asp:BoundField DataField = "Col" HeaderText = "Col" Visible = False />
                        <asp:BoundField DataField = "Num_CNJ" HeaderText = "Num CNJ" Visible = true 
                            ItemStyle-Width="160px"  >
<ItemStyle Width="160px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField = "Nomeacao" HeaderText = "Nomeacao" Visible = false 
                            DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="60px" >
<ItemStyle Width="60px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField = "Aceite" HeaderText = "Aceite" Visible = true 
                            ReadOnly="False" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="60px" >
<ItemStyle Width="60px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField = "Negacao" HeaderText = "Negacao" Visible = true 
                            DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="60px" >
<ItemStyle Width="60px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField = "Liberacao" HeaderText = "Liberacao" 
                            Visible = False DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="60px" >
<ItemStyle Width="60px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField = "jg" HeaderText = "jg" Visible = False />
                        <asp:BoundField DataField = "cod_tipo_pericia" HeaderText = "cod_tipo_pericia" Visible = False />
                        <asp:BoundField DataField = "CodProfissao" HeaderText = "CodProfissao" Visible = False />
                        <asp:BoundField DataField = "CodEspecialidade" HeaderText = "CodEspecialidade" Visible = False />
                        <asp:BoundField DataField = "DescProfissao" HeaderText = "Profissao" Visible = true ItemStyle-Width="90px"  />
                        <asp:BoundField DataField = "DescEspecialidade" HeaderText = "Especialidade" Visible = true ItemStyle-Width="90px" />
                      </Columns>
                </cc1:DGTECGridView>
            </td>
            </tr>
    ...
    <table border="0" cellpadding="10" width="520">
            <tr>
            <td><cc1:DGTECLinkButton ID="lnkVisualizaProcesso" runat="server" Visible ="false" >Visualiza processo.</cc1:DGTECLinkButton></td>
            </tr>
     </table>  
