                                    ...
                                    <tr>
                                        <td style="width: 49px">
                                            ...
                                            <cc1:DGTECTextBox ID="txtCod_Perito" runat="server" Visible="False" Height="17px"
                                                Width="10px" />
                                            <cc1:DGTECTextBox ID="TxtNum_Anotacao" runat="server" Visible="False" Height="17px"
                                                Width="10px" />
                                        </td>
                                        <td>
                                        </td>
                    ...
                    <cc1:DGTECGridView ID="GrdAnotacoes" runat="server" Width="268px" EmptyDataText="NÃO HÁ REGISTROS"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false">
                                <ItemTemplate>
                                   <asp:ImageButton ImageUrl="imagens\img_lupa.gif" ID="btnGrdVisualizar" 
                                        runat="server"  CausesValidation="False" CommandName="btnGrdVisualizar_Command"
                                    
                                        CommandArgument='<%# eval("Cod_tipo_anotacao")&","& eval("Dt_Anot")&","& eval("ID_PF")&","& eval("NUM_ANOTACAO") %>' Text="Visualizar"
                                    OnCommand="btnGrdVisualizar_Command"></asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <%--<asp:BoundField DataField="Num_Anotacao" HeaderText="Num_Anotacao" />--%>
                        </Columns>
