...
Partial Public Class PagMenu
    ...
    Public Shared Nome_Ambiente As String
    ...
    Private Sub PagMenu_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not Session("JANELAS") Is Nothing Then
            For Each estAut In Session("JANELAS")
                ...
                If UCase(estAut.janela) = "FRMESPECIALIDADE.ASPX" Then
                    ...
                    End If
                End If
                If UCase(estAut.janela) = "FRMPRECADASTROPERITOJUIZO.ASPX" Then
                    If estAut.indAutorizado = "S" Then
                        Session("EDITA_SERVENTIA") = "1"
                        UsuarioAutorizado = "SERV"
                        Session("UsuarioAutorizado") = UsuarioAutorizado
                        ' Response.Redirect("Principal.aspx")
                    End If
                End If
        ...
        If App.ConfigurationManager.AppSettings("AMBIENTE") = "3" Then
            Session("AmbienteServidor") = "PRODUÇÃO"
        ElseIf App.ConfigurationManager.AppSettings("AMBIENTE") = "2" Then
            Session("AmbienteServidor") = "HOMOLOGAÇÃO"
        Else
            Session("AmbienteServidor") = "HOMOLOGAÇÃO P7"
        End If
