...
Partial Public Class frmEscolherPerito
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim m_Cod_Especialidade As New Integer
    ...
    Function PreencherPeritos(ByVal mm_Cod_Profissao As Integer, ByVal mm_Cod_Especialidade As Integer) As Boolean
        ...
        If Not dsfila Is Nothing Then
            If dsfila.Tables(0).Rows.Count = 0 Then
                Session("Msg") = "Não há perito cadastrado nesta Comarca para a especialidade selecionada."
    ...
    Private Sub GrdPeritos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GrdPeritos.RowCommand
        ...
        If e.CommandName = "Curriculum" Then
            ...
            mm_ID_PF = CInt(GrdPeritos.Rows(indice).Cells(4).Text)
        ...
        ElseIf e.CommandName = "Selecionar" Then
            ...
            'logger.Debug("GrdPeritos.Rows(indice).Cells(4).Text: " & GrdPeritos.Rows(indice).Cells(4).Text)
            txtID_PF.Text = GrdPeritos.Rows(indice).Cells(4).Text
            Session("ID_PF") = GrdPeritos.Rows(indice).Cells(4).Text
        ...
        ElseIf e.CommandName = "Foto" Then
            ...
            If GrdPeritos.Rows(Convert.ToInt32(e.CommandArgument)).Cells(4).Text = "" Or CInt(GrdPeritos.Rows(Convert.ToInt32(e.CommandArgument)).Cells(4).Text) = 0 Then
            ...
            Else
                ...
                Ent = Bal.ExibirDadosEnt("ID", GrdPeritos.Rows(Convert.ToInt32(e.CommandArgument)).Cells(4).Text, "N")
                If Not Ent Is Nothing Then
