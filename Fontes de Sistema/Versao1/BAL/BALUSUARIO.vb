...
Public Class BALUSUARIO
    ...
    Public Function ExibirNomeUsuario(ByVal pLogin As String) As String

        'By Julio - 29/08/2011

        Dim dr As OracleDataReader
        Dim pNome_Usu As String = ""
        Dim sSql As String

        Try

            sSql = "Select nome_usu From usuario Where upper(cod_usu) = ?"

            dr = sd.ExecuteReader(sSql, UCase(pLogin))
            If dr.Read Then
                pNome_Usu = dr("nome_usu")
            End If
            dr.Close()
