...
Public Class BalPagamento_Perito
    ...
    Public Function ExibirDadosSet(ByVal sNum_CNJ As String, ByVal nID_PF As Long, _
                                   ByVal nCodEspecialidade As Integer, ByVal dData_Nomeacao As Date) As DataSet
        Dim dsSet As DataSet
        dsSet = ExibirDados(sNum_CNJ, nID_PF, nCodEspecialidade, dData_Nomeacao)
        Return dsSet
    End Function

    Public Function ExibirDadosEnt(ByVal sNum_CNJ As String, ByVal nID_PF As Long, _
                                   ByVal nCodEspecialidade As Integer, ByVal dData_Nomeacao As Date) As EntPagamento_Perito
        Dim EntRet As New EntPagamento_Perito
        Dim DsCNJ As DataSet

        DsCNJ = ExibirDadosSet(sNum_CNJ, nID_PF, nCodEspecialidade, dData_Nomeacao)
    ...
    Public Sub GravarPagamento_Perito(ByVal pNum_CNJ As String, ByVal pID_PF As Long, ByVal pDATA_AUTORIZACAO As String, ByVal pDATA_CANCELAMENTO As String, ByVal pCOD_TIPO_PERICIA As Integer, ByVal pCOD_ESPECIALIDADE As Integer, ByVal pNUM_PROT As Long, ByVal pDATA_ENVIO_DGPCF As String, ByVal pDATA_NOMEACAO As String)
        ...
        ParametrosPagamento_Perito(8) = New ServicoDadosOracle.ParameterInfo("dDATA_NOMEACAO", OracleDbType.Date, ParameterDirection.Input)

        If pDATA_NOMEACAO = "" Then
            ParametrosPagamento_Perito(8).Valor = System.DBNull.Value
        Else
            If IsDate(pDATA_ENVIO_DGPCF) Then
                ParametrosPagamento_Perito(8).Valor = CDate(pDATA_NOMEACAO)
            Else
                ParametrosPagamento_Perito(8).Valor = System.DBNull.Value
            End If
        End If

        DsExibir = ExibirDados(pNum_CNJ, pID_PF, pCOD_ESPECIALIDADE, pDATA_NOMEACAO)
    ...
    Public Function ExibirDados(ByVal pNum_CNJ As String, ByVal pID_PF As Long, _
                                ByVal pCodEspecialidade As Integer, ByVal pData_Nomeacao As Date) As DataSet
        ...
        ParametrosExibir(4) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("dData_Nomeacao", OracleDbType.Date, ParameterDirection.Input)
        ParametrosExibir(4).Valor = pData_Nomeacao

        Try
            sd.Open()

            Return sd.CreateDataSet("ExibirDados_Pagamento_Perito", ParametrosExibir)
    ...
    Public Function ExibirDadosSetPer(ByVal pID_PF As Long) As DataSet
        ...
        Try
            ...
            Return sd.CreateDataSet("ExibirDadosPer_Pag_Perito", ParametrosExibir)
    ...
    Public Function ExibirDadosTodos(ByVal pNum_CNJ As String) As DataSet
        ...
        Try
            ...
            Return sd.CreateDataSet("ExibirDados_pagamento_PeritoT", ParametrosExibir)
