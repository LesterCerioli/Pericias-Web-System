...
Public Class BALPERITO
    ...
    '+ 1 -> Dias de Prorrogacao
    'Dim Parametros(28) As ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo
    ...
    Public Function ExibirDadosEnt(ByVal pTipo As String, ByVal psFiltro As String, ByVal ExibirExcl As String, Optional ByVal pCod_Orgao_Per As Integer = 0) As EntPERITO
        ...
        dsSet = ExibirDados(pTipo, psFiltro, ExibirExcl, pCod_Orgao_Per)
            ...
            If dsSet.Tables(0).Rows.Count > 0 Then
                ...
                sCPF = dsSet.Tables(0).Rows(0).Item("cpf").ToString
                For Each r As DataRow In dsSet.Tables(0).Rows
                    If UCase(pTipo) = "NOME" Then
                        ...
                        End If
                    End If
                    If UCase(pTipo) = "CPF" Then
                        If sCPF <> r("cpf").ToString Then
                            EntBal = Nothing
                            Return EntBal
                            Exit Function
                        End If
                ...
                If dsSet.Tables(0).Rows.Count > 1 Then
                    For Each r As DataRow In dsSet.Tables(0).Rows
                        If Not r("Data_Exclusao") > CDate("01/01/1900") Then
                            GerarEntidade(dsSet.Tables(0).Rows(ContaReg))
                        End If
                        ContaReg = ContaReg + 1
                    Next
                Else
    ...
    Public Function ExibirDadosCadPeritoEnt(ByVal pTipo As String, ByVal psFiltro As String, ByVal ExibirExcl As String) As EntPERITO
        ...
        Dim sCPF As String
        Dim ContaReg As Integer = 0
        'Sem filtro gera muitos registros
        If psFiltro = "" Then
            Return Nothing
        End If
    ...
    Public Function ExibirDadosSet(ByVal pTipo As String, ByVal psFiltro As String, ByVal ExibirExcl As String, Optional ByVal pCod_Orgao_Per As Integer = 0) As DataSet
            ...
            Return ExibirDados(pTipo, psFiltro, ExibirExcl, pCod_Orgao_Per)
    ...
    Public Function ExibirTodosDadosSet(ByVal pTipo As String, ByVal psFiltro As String, Optional ByVal pCod_Orgao_Per As Integer = 0) As DataSet
        ...
        Return ExibirTodosDados(pTipo, psFiltro, pCod_Orgao_Per)

    End Function

    Public Function ExibirDadosSet(ByVal pID_PF As Long) As DataSet

        Return ExibirDados(pID_PF)
    ...
    Public Function ExibirDados(ByVal Tipo As String, ByVal sFiltro As String, ByVal ExibirExcluido As String, Optional ByVal pCod_Orgao_Per As Integer = 0) As DataSet
        ...
        Try
            ...
            ds = sd.ExecutaProcDS("ExibirDados_Perito", sd.CriaRefCursor, "PF.NOME", Tipo, UCase(Replace(sFiltro, "'", "")), CInt(pCod_Orgao_Per), ExibirExcluido)

            If ds.Tables(0).Rows.Count = 0 And Tipo = "CPF" Then
                Return sd.ExecutaProcDS("EXIBIRDADOS_PERITO_CPF", sd.CriaRefCursor, sFiltro)
            Else
                Return ds
            End If
    ...
    Public Function ExibirDadosCadPerito(ByVal Tipo As String, ByVal sFiltro As String, ByVal ExibirExcluido As String) As DataSet
        ...
        Try
            ...
            Return sd.ExecutaProcDS("ExibirDados_CADPerito", sd.CriaRefCursor, "PF.NOME", Tipo, UCase(Replace(sFiltro, "'", "")), ExibirExcluido) 'ParametrosExibir)
    ...
    Public Function ExibirTodosDados(ByVal Tipo As String, ByVal sFiltro As String, ByVal ExibirExcl As String, Optional ByVal pCod_Orgao_Per As Integer = 0) As DataSet
        ...
        Try
            ...
            Return sd.ExecutaProcDS("ExibirTodosDados_Perito", sd.CriaRefCursor, "PF.NOME", Tipo, UCase(Replace(sFiltro, "'", "")), CInt(pCod_Orgao_Per))
    ...
    Public Function ExibirDadosConta(ByVal pCPF As String) As DataSet
        ...
        Try
            ...
            Return sd.ExecutaProcDS("ExibirDados_Conta_Perito", sd.CriaRefCursor, pCPF)
    ...
    Public Function ExibirDados(ByVal nID_PF As Long) As DataSet
        ...
        Try
            ...
            Return sd.ExecutaProcDS("ExibirDados_Perito_ID", sd.CriaRefCursor, nID_PF)
    ...
    Public Function ExibirDadosPerDCP(ByVal pCod_Profissao As Integer, ByVal pCod_Especialidade As Integer, Optional ByVal pCod_Comarca As Integer = 0) As DataSet
        ...
        'Ativo e se atua nesta comarca e docs OK e nao excluidos, ordendos por qte de processos
            ...
            Try
                ...
                Return sd.CreateDataSet("ExibirDados_PeritoDCP", ParametrosExibir)
    ...
    Public Function ExibirDadosPFEndereco(ByVal pID_PF As String) As DataSet
        ...
        ParametrosExibir(1).Valor = pID_PF
            ...
            Try
                ...
                Return sd.CreateDataSet("ExibirDados_Perito_Endereco", ParametrosExibir)
    ...
    Public Function ExibirDadosPFEmail(ByVal pID_PF As String) As DataSet
        ...
        Try
            ...
            Return sd.CreateDataSet("ExibirDados_Perito_Email", ParametrosExibir)
    ...
    Private Sub GerarEntidade(ByVal Rss As DataRow) 'As EntPERITO
        ...
        Try
            ...
            EntBal.SITUACAO_CADASTRO = NVL(Rss("SITUACAO_CADASTRO"), "P") 'Tabela Perito
    ...
    Private Sub GerarEntidadePFEndereco(ByVal Rss As DataRow) 'As EntPERITO
        ...
        ElseIf EntBal.Cod_Tip_End = 1 Then
            ...
            EntBal.Descr_Bairro1 = NVL(Rss("Descr_Bairro"), "") 'Tabela Bairro
    ...
    Public Sub Gravar(ByVal Ent_Perito As EntPERITO, ByVal pInserirConta As Boolean)
        ...
        Try
            ...
            'VerCPFPerito - Verifica se CPF está cadastrado como perito na base UC. Se existir retorna true.
            If Not VerCPFPerito(Ent_Perito.CPF) Then
                'logger.Debug("CPF " & Ent_Perito.CPF & " não cadastrado como perito.")
                mm_ID_PF = Ent_Perito.ID_PF

                'If mm_ID_PF = 0 Then
                CriarParametrosPF(Ent_Perito, 1)

                'logger.Debug("uc.Pericias_PKG.Inserir_Pessoafisica")
                sd.ExecuteNonQuery("uc.Pericias_PKG.Inserir_Pessoafisica", ParametrosPF)

                mm_ID_PF = CLng(ParametrosPF(0).Valor.ToString)
                Ent_Perito.ID_PF = CLng(ParametrosPF(0).Valor.ToString)

            End If

            If Not VerificaSeIDPFExisteEmPerito(Ent_Perito.ID_PF) Then
                CriarParametros(Ent_Perito, Ent_Perito.ID_PF)
                'logger.Debug("Inserir_Perito, ID_PF = " & Ent_Perito.ID_PF)
                sd.ExecuteNonQuery("Inserir_Perito", Parametros)
                mm_ID_PF = Ent_Perito.ID_PF
            End If

            If Ent_Perito.ID_PF = 0 Or Ent_Perito.ID_PF = Nothing Then
                'logger.Debug("CPF não existe na tabela de pessoafisica.")
                CriarParametrosPF(Ent_Perito, 1)
                ...
                'logger.Debug("Retorno da inclusão na pessoafisica, id_pf = " & Ent_Perito.ID_PF.ToString)
                ...
                'logger.Debug("Inserir_Perito")
                sd.ExecuteNonQuery("Inserir_Perito", Parametros)

                If pInserirConta Then
                    'logger.Debug("GravarContaCorrente")
    ...
    Private Sub CriarParametros(ByVal entbal As EntPERITO, ByVal m_ID_PF As Long)
        ...
        iii = iii + 1
        ''28
        'Parametros(iii) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("nDias_Prorrogacao", OracleDbType.Int32, ParameterDirection.Input)
        'Parametros(iii).Valor = IIf(entbal.Dias_Prorrogacao = Nothing, System.DBNull.Value, entbal.Dias_Prorrogacao)
        'iii = iii + 1
    ...
    Private Sub CriarParametrosPF(ByVal entBal1 As EntPERITO, ByVal Inserir As Integer)
        ...
        ''''''''''''''''''''''''''''''''''''''''''''
                ...
                'Retorna a situação do Perito para atualização na pessoaFisicaFuncao
        Dim CodTipSituacao As Integer
        ...
        Try
            ...
            ParametrosPF(ii).Valor = IIf(CodTipSituacao = 0, 2, CodTipSituacao)
    ...
    Function GravarFornecedor(ByVal Ent_Perito As EntPERITO) As String
        ...
        Dim ParametrosFornIncl(12) As ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo
        Dim ParametrosFornAlter(13) As ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo
        Dim j As Integer
        ...
        sSQL = "Select Nome_fornec from fornecedores where COD_CGC_CPF = ? " ' & Ent_Perito.CPF & "'"
        ...
        Try
            ...
            If Not Ent_Perito.Nome_Logr Is Nothing Then
                pComplemento = IIf(Ent_Perito.Descr_Tip_Logr = Nothing, " ", Ent_Perito.Descr_Tip_Logr) & _
                               ...
                               " " + IIf(Ent_Perito.Num_Logr = Nothing, " ", Ent_Perito.Num_Logr) & _
                               " " + IIf(Ent_Perito.Compl_Logr = Nothing, " ", Ent_Perito.Compl_Logr)
            Else
                pComplemento = IIf(Ent_Perito.Descr_Tip_Logr1 = Nothing, " ", Ent_Perito.Descr_Tip_Logr1) & _
                               " " + IIf(Ent_Perito.Nome_Logr1 = Nothing, " ", Ent_Perito.Nome_Logr1) & _
                               " " + IIf(Ent_Perito.Num_Logr1 = Nothing, " ", Ent_Perito.Num_Logr1) & _
                               " " + IIf(Ent_Perito.Compl_Logr1 = Nothing, " ", Ent_Perito.Compl_Logr1)
            End If
            ...
            '10...sEmail         varchar2, tamanho (11)
            ParametrosFornIncl(j) = New ServicoDadosOracle.ParameterInfo("sEMAIL", OracleDbType.Varchar2, ParameterDirection.Input)
            ParametrosFornIncl(j).Valor = IIf(Ent_Perito.EMAIL = Nothing, "", UCase(Ent_Perito.EMAIL))
            ParametrosFornAlter(j) = ParametrosFornIncl(j)
            ParametrosFornAlter(j).Valor = ParametrosFornIncl(j).Valor
            j = j + 1
            '11...sEmail1         varchar2, tamanho (11)
            ParametrosFornIncl(j) = New ServicoDadosOracle.ParameterInfo("sEmail1", OracleDbType.Varchar2, ParameterDirection.Input)
            ParametrosFornIncl(j).Valor = IIf(Ent_Perito.EMAIL1 = Nothing, "", UCase(Ent_Perito.EMAIL1))
            ParametrosFornAlter(j) = ParametrosFornIncl(j)
            ParametrosFornAlter(j).Valor = ParametrosFornIncl(j).Valor
            j = j + 1
            ...
            If Not Alteracao Then
                ...
                Return sd.ExecutaFunc("Grava_TmpForn", 250, _
                ...
                ParametrosFornIncl(10).Valor, _
                ParametrosFornIncl(11).Valor, _
                ParametrosFornIncl(12).Valor)
            Else
                Return sd.ExecutaFunc("pacote_perito.altera_perito", 300, ParametrosFornAlter(0).Valor, ParametrosFornAlter(1).Valor, ParametrosFornAlter(2).Valor, ParametrosFornAlter(3).Valor, ParametrosFornAlter(4).Valor, ParametrosFornAlter(5).Valor, ParametrosFornAlter(6).Valor, ParametrosFornAlter(7).Valor, ParametrosFornAlter(8).Valor, ParametrosFornAlter(9).Valor, ParametrosFornAlter(12).Valor, ParametrosFornAlter(13).Valor, ParametrosFornAlter(10).Valor, ParametrosFornAlter(11).Valor)
            End If
    ...
    Public Function VerificaSeIDPFExisteEmPerito(ByVal sIDPF As String) As Boolean
        ...
        Try
            ...
            nRetorno = sd.ExecuteScalar("select 1 from peritos where id_pf = ?", sIDPF)
        ...
        'RAFAELOL Sugestão para function

        'Public Function VerificaSeIDPFExisteEmPerito(ByVal sIDPF As String) As Boolean

        'Return sd.ExecuteReader("select 1 from peritos where id_pf = ?", sIDPF).HasRows

        'End Function

    End Function

    'Localizar ID_PF em PessoaFisica pelo CPF

    Public Function VerPeritoPericias(ByVal pCPF As String) As Long

        Dim sSQL As String

        Try

            sSQL = "Select ID_PF from Peritos, PessoaFisica pf where pf.id_pf =p.id_pf and PF.CPF = ?  "
            ...
            Else
                ...
                dr = sd.ExecuteReader(sSQL, pCPF)
                If dr.Read Then
                    'Inserir ID_PF, status Pendente, Data_Cadastramento, Data de Exclusão 
                    sd.ExecuteNonQuery("Inserir_ID_Perito", dr("ID_PF"))
                    Return dr("ID_PF")
                Else
                    Return 0
                End If
    ...
    Public Function VerCPFPerito(ByVal pCPF As String) As Boolean
        ...
        Try
            ...
            '    return sd.ExecuteReader(sSQL, pCPF).HasRows
    ...
    Public Function VerHomonimo(ByVal pNome As String) As Boolean
        ...
        Try
            ...
            '    'PFF.Cod_Tip_Func = 4 (Tipo -> Perito)
            '    sSQL = "Select * from UC.PessoaFisica PF, UC.PessoaFisicaFuncao PFF where PF.Nome = ?  and PFF.Cod_Tip_Func = 4 and PFF.ID_PF = PF.ID_PF"

            '    Return IIf(sd.ExecuteReader(sSQL, pNome).RecordsAffected() > 1, True, False)
    ...
    Public Function Nome_ID(ByVal pID As String) As String
        ...
        Try
            ...
            '    return sd.ExecuteReader(sSQL, Convert.ToInt64(pID))("Nome").ToString()
    ...
    Function ValidarPeritoCPF(ByVal pId_USU As Integer) As String
        ...
        Try
            ...
            '    Function ValidarPeritoCPF(ByVal pId_USU As String) As String
            '    Dim sSQL As String
            '    
            '    sSQL = "Select pf.CPF from UC.PessoaFisica PF, UC.PessoaFisicaFuncao PFF, Usuario U, Peritos P " & _
            '           "where U.ID_USU = ? and PFF.Cod_Tip_Func = 4 and PFF.ID_PF = PF.ID_PF and U.CPF_USU = PF.CPF and " & _
            ...
            '   Return sd.ExecuteReader(sSQL, pId_USU.ToString)(0).ToString()
    ...
    Function ValidarPerito(ByVal pId_USU As Integer) As Boolean
        ...
        Try
            ...
            'RAFAELOL Sugestão para a function

            ' Function ValidarPerito(ByVal pId_USU As String) As Boolean
            ...
            '    Return sd.ExecuteReader(sSQL, pId_USU).HasRows
    ...
    Function ID_Perito(ByVal pId_PF As Integer) As String
        ...
        Try
            ...
            ' Function ID_Perito(ByVal pId_PF As String) As String
            ...
            '     Return sd.ExecuteReader(sSQL, pId_PF)("ID_PF").ToString()
    ...
    Function LocalizaCPFPerito(ByVal pId_PF As Integer) As String
        ...
        Try
            ...
            'Function LocalizaCPFPerito(ByVal pId_PF As String) As String

            'Dim sSQL As String
            'sSQL = "Select CPF from UC.PessoaFisica PF, UC.PessoaFisicaFuncao PFF where PF.ID_PF = ?  and PFF.Cod_Tip_Func = 4 and PFF.ID_PF = PF.ID_PF"

            'return sd.ExecuteReader(sSQL, pId_PF)("CPF").ToString()
    ...
    Private Sub CriarParametrosExt(ByVal entbal As EntPERITO, ByVal m_ID_PF As Long)
        ...
        ParametrosExt(iii).Valor = "INTRANET"
        iii = iii + 1
        'DATA_CADASTRAMENTO       DATE
    ...
    Public Sub LimpaPreCadastro()
        ...
        Try
            ...
            sd.ExecutaProc("LimpaPreCadastro")
    ...
    Public Function RetornaUltimoSeqEnd(ByVal sIDPF As String) As Integer
        ...
        Try
            ...
            Return sd.ExecutaFunc("UltimoSeqEndereco", 250, sIDPF)
    ...
    Public Function RetornaUltimoSeqTel(ByVal sIDPF As String) As Integer
        ...
        Try
            ...
            Return sd.ExecutaFunc("ultimoseqtelefone", 50, sIDPF)
    ...
    End Function
    Public Function ExibirIDTodosPeritos() As DataSet

        Dim ParametrosTotal(0) As ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo

        ParametrosTotal(0) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("cRet", OracleDbType.RefCursor, ParameterDirection.Output)

        Try

            sd.Open()

            Return sd.CreateDataSet("ExibirIDPeritos", ParametrosTotal)
    ...
    Public Function TotalIDTodosPeritos() As Integer

        Dim sSQl As String
        sSQl = "Select count(PF.ID_PF) Total from peritos P, pessoafisica PF where PF.Id_PF = P.ID_PF and (not IDGED_Foto is null or not IDGED_CV is null)"
    ...
    Public Function ID_PF_CPF(ByVal pID_PF As Long) As String

        Dim sSQl As String
        sSQl = "Select CPF from peritos P, pessoafisica PF where PF.Id_PF = P.ID_PF and P.ID_PF = ? "

        Try

            sd.Open()

            Dim dr As OracleDataReader = sd.ExecuteReader(sSQl, pID_PF)
    ...
    Function VerPeritoPericias(ByVal p1 As String, ByVal p2 As String) As Long
