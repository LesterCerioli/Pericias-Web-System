...
#Region "Campos"
    ...
    Private _id_pj As Int64
    Public Property ID_PJ() As Int64
        Get
            Return _id_pj
        End Get
    ...
    Private _cod_tip_status As Int64
    Public Property CodigoStatusAtual() As Int64
        Get
            Return _cod_tip_status
        End Get
        Set(ByVal value As Int64)
            _cod_tip_status = value
        End Set
    End Property

    Private _historico_status_atual As Int64
    Public Property HistoricoStatusAtual() As Int64
        Get
            Return _historico_status_atual
        End Get
        Set(ByVal value As Int64)
            _historico_status_atual = value
        End Set
    End Property


    Private _statusAtual As TIPO_STATUS
    Public Property StatusAtual() As TIPO_STATUS
        Get
            Return _statusAtual
        End Get
        Set(ByVal value As TIPO_STATUS)
            _statusAtual = value
        End Set
    End Property

    Private _tipoPessoa As Integer
    ...
    Private _datamigracao As Date
    Public Property DataMigracao() As Date
        Get
            Return _datamigracao
        End Get
