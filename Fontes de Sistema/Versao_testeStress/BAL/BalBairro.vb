...
Public Class BALBairro
    ...
    '            Exit Function
    '        End If
    '        ds = sd.CreateDataSet("ExibirDados_Bairro", oParam)
    '        Return ds
    ...
    Public Function ExibirDadosSet(ByVal pCod_Cid As Long) As DataSet
        ...
        Try
            sd.Open()
            oParam(0) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("cRet", OracleDbType.RefCursor, ParameterDirection.Output)
            oParam(1) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("nCod_Cid", OracleDbType.Int64, ParameterDirection.Input)
            oParam(1).Valor = pCod_Cid
            ds = sd.CreateDataSet("ExibirDados_Bairro", oParam)
            Return ds
        Catch ex As Exception
            Throw ex
