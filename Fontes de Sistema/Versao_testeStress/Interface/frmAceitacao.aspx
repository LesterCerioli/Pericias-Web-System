<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PerMasterPagePerito.Master" CodeBehind="frmAceitacao.aspx.vb" Inherits="Interface.frmAceitacao" 
  %>
...
<table class="corpo-form">
    <tr>
    <th align="center">
                    ACEITAÇÃO / RECUSA DA PERÍCIA</th>
    </tr>
    <tr>
    <td>
    ...
    <table border="0" cellpadding="10" width="520">
            <tr>
            <td><cc1:DGTECLinkButton ID="lnkVisualizaProcesso" runat="server" Visible ="false" >Visualiza 
                processo.</cc1:DGTECLinkButton></td>
            </tr>
     </table>  
