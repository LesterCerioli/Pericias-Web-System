<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PerMasterPagePerito.Master" CodeBehind="teste.aspx.vb" Inherits="Interface.teste" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Tela" runat="server">
    ...
    <form id="form1" runat="server" method="post" enableviewstate="true">
    ...
    <div>
      ...
      <cc1:DGTECPanel ID="PanelTel" runat="server" Visible="False">
            <table border="0" cellpadding="10" width="520">
                <tr>
                    <td align="center">
                        TELEFONES
         ...
         <cc1:DGTECPanel ID="PanelInf" runat="server" Visible="False">
            <table border="0" cellpadding="10" width="520">
                <tr>
                    <td align="center">
       ...
       <cc1:DGTECPanel ID="PanelChklist" runat="server" Visible="False">
            <table border="0" cellpadding="10" width="520">
                <tr>
                    <td align="center">
