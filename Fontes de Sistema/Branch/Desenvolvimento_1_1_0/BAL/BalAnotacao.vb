...
Public Class BALAnotacao
    ...
    Public Function ConsultarAnotacao(ByVal pCodTipAnotacao As String, ByVal pDtAnotacao As String, ByVal pIdPF As String) As EntAnotacao
        'Public Function ConsultarAnotacao(ByVal pArgumentos As String) As EntAnotacao
        Dim ds As DataSet
        Dim param(3) As ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo

        param(0) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("CRet", OracleDbType.RefCursor, ParameterDirection.Output)

        param(1) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("vCodTipAnotacao", OracleDbType.Varchar2, ParameterDirection.Input)
        param(1).Valor = pCodTipAnotacao

        param(2) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("vDTAnotacao", OracleDbType.Varchar2, ParameterDirection.Input)
        param(2).Valor = pDtAnotacao

        param(3) = New ServicoDadosODPNET.ServicoDadosOracle.ParameterInfo("vID_PF", OracleDbType.Varchar2, ParameterDirection.Input)
        param(3).Valor = pIdPF
    ...
    Public Function VerificaSeJaFoiIncluidoAnotacaoNoDia(ByVal pIdPF As String) As Integer
        ...
        retorno = CInt(sd.ExecutaFunc("VERIFICA_SE_HA_ANOTACAO_DIA", 1, pIdPF))
