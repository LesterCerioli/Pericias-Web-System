            ...
            <tr>
                <td style="width: 527px;">
                    ...
                    <cc1:DGTECPanel ID="pnlInfNomeacaoPerito" runat="server" 
                       ...
                       <table width="520"  border="0" cellpadding="10" >
                            <tr align="center">
                                <td>
                                ...
                                <td >
                                    <cc1:DGTECButton ID="BtnAnotacao" runat="server" Height="17px" TextMode="multiline"
                                        Text="Enviar Anotações à DIPEJ" Width="158px" Enabled="False" />
                                </td>
                            </tr>
                        </table>
                </td>
